checkin = LOAD '/yelp_data/checkin.json' USING JsonLoader('business_id:chararray, date:chararray');
...
store final into '/yelp_data/checkins_by_date_by_business_pig' using PigStorage(',');
