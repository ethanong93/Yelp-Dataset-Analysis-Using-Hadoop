...
load data inpath '/yelp_data/business_reviews/*.csv' into table yelp.business_reviews;
...
--Load the data from HDFS into the created hive table
load data inpath '/yelp_data/checkins_by_date_by_business/part*' into table yelp.checkins_by_date_by_business;
